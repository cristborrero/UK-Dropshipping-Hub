  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-brand-dark">Notification Center</h1>
        ...
        {unreadCount > 0 && (
          <Form method="post">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-brand-accent hover:bg-[#7c3aed] active:bg-[#6d28d9] disabled:opacity-50 text-white text-xs font-semibold rounded-lg shadow-sm transition-all cursor-pointer"
            >
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm">
            <div className="px-5 py-4 border-b border-gray-100 flex items-center justify-between bg-white">
              <h2 className="text-sm font-semibold text-brand-dark flex items-center gap-2.5">
            ...
            <div className="divide-y divide-gray-100 max-h-[600px] overflow-y-auto">
              {notifications.length === 0 ? (
                <div className="p-12 text-center text-gray-400">
                  ...
                  <p className="text-sm font-semibold text-brand-dark">No notifications found.</p>
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center justify-between gap-4">
                          <h3 className={`text-sm font-semibold truncate ${notif.isRead ? 'text-gray-500' : 'text-brand-dark'}`}>
                            {notif.title}
                          </h3>
                      ...
                      {!notif.isRead && (
                        <Form method="post" className="shrink-0 self-center">
                          ...
                          <button
                            ...
                            title="Mark as read"
                            disabled={isSubmitting}
                            className="p-1.5 rounded-xl text-gray-400 hover:text-brand-dark hover:bg-gray-100 transition-all cursor-pointer"
                          >
          ...
          <div className="bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm">
            ...
            <Form method="post" className="p-5 space-y-6">
              ...
              <div className="space-y-3">
                <h3 className="text-xs font-bold text-brand-accent uppercase tracking-wider">Order Status</h3>
                
                <div className="flex items-center justify-between py-1.5 border-b border-gray-100">
                  <div className="flex items-center gap-3">
                    <Mail className="w-4 h-4 text-gray-300" />
                    <div>
                      <p className="text-xs font-semibold text-brand-dark">Email Alerts</p>
                ...
                <div className="flex items-center justify-between py-1.5">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-xs font-semibold text-brand-dark">In-App Badges</p>
              ...
              <div className="space-y-3 pt-2">
                <h3 className="text-xs font-bold text-brand-accent uppercase tracking-wider">Payments & Ledger</h3>
                
                <div className="flex items-center justify-between py-1.5 border-b border-gray-100">
                  <div className="flex items-center gap-3">
                    <Mail className="w-4 h-4 text-gray-300" />
                    <div>
                      <p className="text-xs font-semibold text-brand-dark">Email Confirmations</p>
                ...
                <div className="flex items-center justify-between py-1.5">
                  <div className="flex items-center gap-3">
                    <Smartphone className="w-4 h-4 text-gray-300" />
                    <div>
                      <p className="text-xs font-semibold text-brand-dark">In-App Alerts</p>
              ...
              {/* Return events */}
              <div className="space-y-3 pt-2">
                <h3 className="text-xs font-bold text-brand-accent uppercase tracking-wider">Returns</h3>
              ...
              <button
                type="submit"
                disabled={isSubmitting}
                className="w-full flex items-center justify-center gap-2 py-2.5 bg-[#f5f5f7] hover:bg-gray-100 text-brand-dark text-xs font-semibold rounded-xl shadow-sm transition-all cursor-pointer border border-gray-200/50 active:scale-[0.98]"
              >
                {isSubmitting ? (
