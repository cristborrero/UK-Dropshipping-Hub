      ...
      <Container>
        <FadeIn delay={0.1}>
          ...
          <FadeIn direction="left" delay={0.2} className="flex flex-col justify-center">
            ...
            <Link
              to="/about"
              className="inline-flex items-center justify-center bg-brand-dark text-white hover:bg-white hover:text-brand-dark hover:shadow-[0_0_0_1px_#1a1a1c_inset] font-medium px-8 py-3.5 rounded-full transition-all duration-300 ease-in-out w-fit mb-12 shadow-sm group"
            >
